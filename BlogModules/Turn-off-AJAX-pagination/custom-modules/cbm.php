<?php
/*================================================
#Blog module with the option to deactivate the AJAX pagination
================================================*/
class WPC_ET_Builder_Module_Blog extends ET_Builder_Module {
	...
	function get_fields() {
		$fields = array(
			...
			'ajax_pagination' => array(
				'label'             => esc_html__( 'Use Ajax Pagination', 'et_builder' ),
				'type'              => 'yes_no_button',
				'option_category'   => 'configuration',
				'options'           => array(
					'on'  => esc_html__( 'Yes', 'et_builder' ),
				...
				'description'        => esc_html__( 'Turn the ussage of AJAX pagination on and off.', 'et_builder' ),
				'computed_affects'   => array(
					'__posts',
				),
				'toggle_slug'        => 'elements',
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$ajax_pagination     = $this->shortcode_atts['ajax_pagination'];
	...
	<?php
		...
		if ( 'on' === $ajax_pagination && ! is_search() ) {
		...
		if ( 'off' === $ajax_pagination && ! is_search() ) {
