<?php
/*================================================
#1 Customize Blog module to include an option for the excerpt lenght
================================================*/
class WPC_ET_Builder_Module_Blog extends ET_Builder_Module {
	function init() {
		...
		$this->fields_defaults = array(
			'fullwidth'         => array( 'on' ),
			'excerpt_length'	=> array( 270, 'only_default_setting' ),
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		if ( have_posts() ) {
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'wpc-blog-post et_pb_post clearfix' . $no_thumb_class . $overlay_class  ); ?>>
				...
				<?php
					...
					if ( 'on' === $show_content ) {
						...
						if ( has_excerpt() ) {
							...
							echo wpautop( et_delete_post_first_video( strip_shortcodes( truncate_post( $excerpt_length, false, '', true ) ) ) );
						}
					}
